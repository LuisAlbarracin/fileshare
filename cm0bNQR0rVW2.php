...
<head>
    ...
    <title><?php echo "UFPS FINU |"." ".$filename ?></title>
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b>UFPS</b>FINU</a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="images/profiles/default.png" class="user-image" alt="User Image">
                <!-- hidden-xs hides the username on small devices so only the image appears. -->
                <span class="hidden-xs">UFPS</span>
              </a>
              <ul class="dropdown-menu">
                ...
                <img src="images/profiles/default.png" class="img-circle" alt="User Image">
                  <p>
                     By <a href="#" target="_blank">Admin</a>
                  </p>
                </li>
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="/cpanel" class="btn btn-default btn-flat">admin</a>
                  </div>
                </li>
              </ul>
            </li>
...
<footer class="main-footer"><!-- /.content-wrapper -->
    ...
    <strong>-<?php echo date("Y")?> <a target="_blank" href="#">Soporte</a>.</strong> by: <a target="_blank" href="#">Admin</a>
</footer><!-- ./wrapper -->
</div>
<!-- ./wrapper -->
